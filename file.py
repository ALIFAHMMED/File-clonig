...
import time
os.system("clear")
print("   \033[1;32mMISSION 69 (ALIF) ")
time.sleep(1)
...
def logo():
    print("""
  MISSION 69
   ______   ______  _____ ____        _    _     ___ _____ 
  / ___\ \ / / __ )| ____|  _ \      / \  | |   |_ _|  ___|
 | |    \ V /|  _ \|  _| | |_) |    / _ \ | |    | || |_   
 | |___  | | | |_) | |___|  _ <    / ___ \| |___ | ||  _|  
  \____| |_| |____/|_____|_| \_\  /_/   \_\_____|___|_|    
                                                           
""")
def hasil(ok,cp):
    if len(ALIF_ok) != 0 or len(ALIF_cp) != 0:
        ...
        if cek_cp =="":
            ...
            for memek in cp:
                ...
                titid  = kontol.split(' • ')
                print(f'{N}══════════════════════════════════════════\n {H}LOGIN PROCESS')
                jalan(f' {N}[{M}?{N}] Account : {K}{kontol.replace("[ANDREE-CP] ", "")}{N}')
                try:
...
class __chigoue__:
    ...
    def __metode__(self, cebok, user, pasw):
        global ok,cp,loop
        animasi = random.choice(["\x1b[1;92m[ANDREE]","\x1b[1;92m[ANDREE]","\x1b[1;92m[ANDREE]","\x1b[1;92m[ANDREE]","\x1b[1;92m[ANDREE]","\x1b[1;92m[ANDREE]","\x1b[1;92m[ANDREE]"])
